...
// generic contact to the function that appends other contact information to the header to get a generic contact
...
// biopic and welcome message for header
...
function initializeMap() {
  ...
  */
  function createMapMarker(placeData) {
    ...
    // event listener for the click on the location
